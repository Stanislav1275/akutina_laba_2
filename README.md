...
- [3. Нефункциональные требования](#3-нефункциональные-требования)
  - [3.1. Производительность](#31-производительность)
  - [3.2. Масштабируемость](#32-масштабируемость)
  - [3.3. Эргономичность](#33-эргономичность)
  - [3.4. Надёжность](#34-надёжность)
  - [3.5. Безопасность](#35-безопасность)
- [4. Архитектура приложения](#4-архитектура-приложения)
  - [4.1. Концепция](#41-концепция)
  - [4.2. Компоненты](#42-компоненты)
  - [4.3. Потоки данных и форматы](#43-потоки-данных-и-форматы)
  - [4.4. Нефункциональные акценты](#44-нефункциональные-акценты)
  - [4.5. Преимущества архитектуры без БД](#45-преимущества-архитектуры-без-бд)
- [5. Архитектура интеллектуальной системы](#5-архитектура-интеллектуальной-системы)
  - [5.1. Специфика тепловизионных данных](#51-специфика-тепловизионных-данных)
  - [5.2. Сравнение подходов к детекции на термоснимках](#52-сравнение-подходов-к-детекции-на-термоснимках)
  - [5.3. Обоснование выбора детекционного подхода](#53-обоснование-выбора-детекционного-подхода)
  - [5.4. Выбор конкретной архитектуры: YOLO для тепловизионной детекции](#54-выбор-конкретной-архитектуры-yolo-для-тепловизионной-детекции)
  - [5.5. Практическая применимость](#55-практическая-применимость)
  - [5.6. Соответствие требованиям проекта](#56-соответствие-требованиям-проекта)
- [6. Выбор технологий разработки](#6-выбор-технологий-разработки)
  - [6.1. Принципы выбора](#61-принципы-выбора)
  - [6.2. Обоснование выбора Backend-технологий](#62-обоснование-выбора-backend-технологий)
  - [6.3. Обоснование выбора Frontend-технологий](#63-обоснование-выбора-frontend-технологий)
  - [6.4. Сравнение технологических стеков](#64-сравнение-технологических-стеков)
  - [6.5. Заключение](#65-заключение)
...
## Проектная структура и лабораторные критерии

Команда из трёх человек реализует связную ИИ-систему, разбитую на четыре практических работы: архитектура, сбор данных, реализация и выходной материал. Каждый этап ориентирован на заданные критерии (чистота оформления, структурированность, визуализация, авторитетность источников и т.п.) и завершается конкретным артефактом: ADR/реферат, `ipynb` с подготовкой данных, работоспособная система и техническая статья с численными результатами. 

Основные цели и метрики:

- **Лабораторная работа 1 (Архитектура)** — тема ИИ-проекта с ADR, обоснованием стека и визуализацией сценариев. Оформление строго по академическим стандартам, ссылки на авторитетные источники (например, ADR-репозитории), готовность к защите и снабжение диаграммами потоков.
- **Лабораторная работа 2 (Сбор данных и статистика)** — `ipynb` документ, в котором описаны природа и очистка термальных изображений, статистика, визуализации распределений, подтверждённые источники данных и ссылки на публикации/монографии.
- **Лабораторная работа 3 (Разработка системы)** — развернутая система с промышленными атрибутами (Docker, документация, архитектурные паттерны, готовый UI), которая проходит тестирование «чёрного ящика» и показывает ожидаемую реакцию на вводные сценарии.
- **Лабораторная работа 4 (Выходной материал)** — академическая статья (word/markdown), в которой фиксируется выполнение количественных требований: например, граф принятия решений из 500 вершин, отклик системы ≤10 мс на CPU, обучение до 10 000 эпох с отображением loss/precision и отчётом визуализаций/графиков.

Все файлы хранятся в публичном Git-репозитории, код оформлен чисто (современный стиль, линтеры), а документация содержит ссылки на стандарты. Ниже отображено текущее содержание README, ориентированное на заданные требования.
...
![YOLO accuracy chart](assets/yolo-chart.png)
